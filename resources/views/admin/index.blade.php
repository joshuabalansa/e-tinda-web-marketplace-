...
<head>
	...
	<style>
		.sidebar-menu {
			background-color: #1a472a !important; /* Dark green color */
		}
		.sidebar-menu .main-menu > li > a {
			color: #ffffff !important;
		}
		.sidebar-menu .main-menu > li > a:hover {
			background-color: #2d5a3f !important; /* Slightly lighter green for hover */
		}
	...
	<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.html">
						<i class="fas fa-leaf fa-2x text-success" style="display: block; margin-bottom: 0.5rem; color: white; text-align: center;"></i>
						<h4 class="text-success fw-bold" style="display: block; margin: 0; color: white;">E-Tinda Marketplace</h4>
					</a>
				</div>
