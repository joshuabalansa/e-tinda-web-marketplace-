        ...
        <div class="panel panel-default" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4><i class="entypo-plus"></i> Add Stock</h4>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="transaction_type" id="transaction_type" class="form-control @error('transaction_type') is-invalid @enderror" required>
                                    ...
                                    <option value="loss" {{ old('transaction_type') == 'loss' ? 'selected' : '' }}>Loss/Damage</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity_in" id="quantity_in" class="form-control @error('quantity_in') is-invalid @enderror"
                                       value="{{ old('quantity_in', 0) }}" min="0" step="1">
                                @error('quantity_in')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity_out" id="quantity_out" class="form-control @error('quantity_out') is-invalid @enderror"
                                       value="{{ old('quantity_out', 0) }}" min="0" step="1">
                                @error('quantity_out')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="unit_cost" id="unit_cost" class="form-control @error('unit_cost') is-invalid @enderror"
                                       value="{{ old('unit_cost', 0) }}" min="0" step="0.01">
                                @error('unit_cost')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="reference_number" id="reference_number" class="form-control @error('reference_number') is-invalid @enderror"
                                       value="{{ old('reference_number') }}" placeholder="e.g., PO-001, INV-123">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror"
                                          rows="3" placeholder="Additional notes about this transaction...">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <div class="btn-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="entypo-check"></i> Add Stock
                            </button>
