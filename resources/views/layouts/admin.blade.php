...
<head>
    ...
    <style>
        ...
        /* Dark Green Sidebar Theme Overrides (Same as Farmer) */
        .sidebar-menu,
        ...
        /* Content wrapper to fill remaining space */
...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <!-- Footer -->
        <footer class="main">
            &copy; {{ date('Y') }} <strong>E-Tinda</strong> Admin Panel
        </footer>
    </div>
</div>
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        ...
        console.log('Admin sidebar collapse functionality initialized successfully');
